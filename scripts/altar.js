...
Altar.attributes.add('interactionRadius', { type: 'number', default: 2.0, title: 'Interaction Radius' });
...
Altar.prototype.update = function(dt) {
    ...
    if (dist <= this.interactionRadius) {
        // Mostra hint
        this.app.fire('ui:hint', '✨ Pressione E no altar para completar o ritual!');
...
Altar.prototype._createVictoryScreen = function() {
    ...
    victoryDiv.style.background = "linear-gradient(135deg, rgba(20,20,50,0.95), rgba(50,20,80,0.95))";
    ...
    title.style.textShadow = "4px 4px 8px rgba(0,0,0,0.8), 0 0 20px rgba(255,215,0,0.5)";
